...
class Proprietario
{
    ...
    {
        $stmt = $this->banco->getConexao()->prepare("INSERT INTO profissionais (id_prof, cpf, rg, telefone, ano_cadastro, nome, email, senha) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("isssssss", $this->id_prof, $this->cpf, $this->rg, $this->telefone, $this->ano_cadastro, $this->nome, $this->email, $this->senha);
        return $stmt->execute();
    }
    ...
    public function readAll()
    {
        ...
        while ($linha = mysqli_fetch_object($result)) {
            $vetorProfissionais[$i] = new Proprietario();
